//#region node_modules/notyf/notyf.es.js
/*! *****************************************************************************
...
var NotyfNotification = function() {
	...
	NotyfNotification.prototype.triggerEvent = function(eventType, event) {
		var _this = this;
		(this.listeners[eventType] || []).forEach(function(cb) {
			return cb({
				target: _this,
				event
			});
...
var NotyfView = function() {
	...
	NotyfView.prototype._buildNotificationCard = function(notification) {
		...
		if (mainColor) if (options.ripple) {
...
var Notyf = function() {
	...
	*/
	...
	Notyf.prototype.registerTypes = function(opts) {
		...
		return DEFAULT_OPTIONS.types.map(function(defaultType) {
			var userTypeIdx = -1;
